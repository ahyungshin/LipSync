...
class HeadNeRFLossUtils(object):
    ...
    def calc_data_loss(self, data_dict, gt_rgb, head_mask_c1b, nonhead_mask_c1b):
        ...
        res = {
            "bg_loss": bg_loss,  
            "head_loss": head_loss,  
            "nonhaed_loss": 0.01 * nonhaed_loss,  
        }
    ...
    def calc_total_loss(self, delta_cam_info, opt_code_dict, pred_dict, gt_rgb, mask_tensor):
        ...
        # print(loss_dict["bg_loss"], loss_dict["head_loss"], loss_dict["nonhaed_loss"])
        # print(loss_dict["delta_eular"], loss_dict["delta_tvec"])
        # print(loss_dict["iden_code"], loss_dict["expr_code"], loss_dict["appea_code"], loss_dict["bg_code"])
        # print("==================")
