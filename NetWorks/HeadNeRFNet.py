...
class HeadNeRFNet(nn.Module):
    ...
    def calc_color_with_code(self, aud, fg_vps, shape_code, appea_code, FGvp_embedder, 
        ...
        if fine_level:
            FGmlp_FGvp_rgb, FGmlp_FGvp_density = self.fine_fg_CD_predictor(aud, ori_FGvp_embedder, ori_FGvd_embedder)
        else:
            # [1,242,1024,64] , [1,127,1024,64]
            FGmlp_FGvp_rgb, FGmlp_FGvp_density = self.fg_CD_predictor(aud, ori_FGvp_embedder, ori_FGvd_embedder)
    ...
    def _forward(
        ...
        c_ori_res, batch_weight = self.calc_color_with_code(
            aud, fg_vps, cur_shape_code, cur_appea_code, FGvp_embedder, FGvd_embedder, FG_zdists, FG_zvals, fine_level = False
        )
